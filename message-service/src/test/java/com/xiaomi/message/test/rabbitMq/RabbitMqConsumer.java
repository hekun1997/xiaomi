...
public class RabbitMqConsumer {
    ...
    public static void main(String[] args) {
        ...
        addresses.add(new Address(IP_ADDRESS, PORT));
        ConnectionFactory factory = new ConnectionFactory() ;
        factory.setUsername("admin");
        factory.setPassword("admin");//这里的连接方式与生产者的 demo 略有不同，注意辨别区别
        ...
        channel.basicConsume(QUEUE_NAME , consumer) ; //等待回调函数执行完毕之后 关闭资源
